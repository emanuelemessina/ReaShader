...
BEGIN_FACTORY_DEF("Emanuele Messina",
	...
	DEF_CLASS2(INLINE_UID_FROM_FUID(kReaShaderProcessorUID),
		...
		ReaShaderProcessor::createInstance)	// function pointer called when this component should be instantiated
...
DEF_CLASS2(INLINE_UID_FROM_FUID(kReaShaderControllerUID),
	...
	FULL_VERSION_STR,		// Plug-in version (to be changed)
	kVstVersionString,		// the VST 3 SDK version (do not changed this, use always this define)
	ReaShaderController::createInstance)// function pointer called when this component should be instantiated
