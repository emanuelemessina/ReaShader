...
namespace vkt {
	...
	public:
		...
		*/
		vktCommandPool* createCommandBuffer(const int id) {
			VkCommandBuffer commandBuffer = createCommandBuffer();
			m_commandBuffers.add(id, commandBuffer);
		...
		*/
		...
		Then begins it.
		*/
		vktCommandPool* restartCommandBuffer(VkCommandBuffer& previousCommandBuffer) {
		...
		*/
		vktCommandPool* restartAll() {
			for (const auto& id : std::views::keys(m_commandBuffers.get())) {
				restartCommandBuffer(id);
			}
			return this;
		}
