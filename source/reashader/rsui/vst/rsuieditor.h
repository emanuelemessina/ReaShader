...
namespace ReaShader
{
	...
	namespace RSUI
	{
		...
		class RSUISubController : public VSTGUI::IController, public VSTGUI::ViewListenerAdapter
		{
		  public:
			RSUISubController(ReaShaderController* controller, VST3Editor* editor, const IUIDescription* description);
		...
		class RSUIEditor : public VST3Editor, public ViewMouseListenerAdapter
		{
		  public:
			RSUIEditor(MyPluginController* controller, UTF8StringPtr templateName, UTF8StringPtr xmlFile);
