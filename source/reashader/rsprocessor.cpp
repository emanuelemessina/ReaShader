...
#pragma warning(suppress: w_ptr_m_null) // assert material is not nullptr
	...
	void ReaShaderProcessor::initVulkan() {
...

		{
			...
			texture->createImage(tools::paths::join({ IMAGES_DIR, "reashader text.png" }), VK_ACCESS_SHADER_READ_BIT, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL, VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT);
